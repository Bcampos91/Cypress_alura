...
module.exports = defineConfig({
  ...
  e2e: {
    ...
    reporter:'mochawesome',//“reporter”: essa propriedade define o padrão de geração de relatórios. Configurando como padrão no arquivo cypress.config.js, sempre que o comando npx cypress run for disparado, o tipo de relatório gerado será do Mochawesome, mesmo que não seja incluído a opção --reporter mochawesome.
    reporterOptions:
    {
      reporDir:'cypress/results',//“reportDir”: diretório padrão onde serão gerados os relatórios.
      overwrite:false,//“overwrite”: caso não se inclua um timestamp, o relatório padrão é gerado com o nome mochawesome.json ou mochawesome.html. Para esses casos, definimos se o relatório será sobrescrito ou não.
